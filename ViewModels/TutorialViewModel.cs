...
namespace VoiceBookStudio.ViewModels
{
    ...
    public partial class TutorialViewModel : ObservableObject
    {
        ...
        /// <summary>
        /// JAWS state as known at construction — baked into the step text generated by
        /// BuildSteps (e.g. "Your Setup"), which is written once and not worth
        /// regenerating live.
        /// </summary>
        ...
        /// <summary>
        /// Live JAWS state, re-read from AppSettings on every narration decision instead
        /// of trusting the constructor snapshot in <see cref="_jawsDetected"/>. Startup
        /// detection can still be catching up (JAWS 2026's sign-in delay) when the
        /// tutorial is constructed; App.xaml.cs's watcher corrects AppSettings.IsJawsDetected
        /// within 15 seconds once it does, and narration should follow that correction
        /// immediately rather than staying wrong — wrongly silent, or wrongly talking over
        /// JAWS — for the rest of the tutorial.
        /// </summary>
        private static bool IsJawsDetectedNow => VoiceBookStudio.Utils.AppSettings.IsJawsDetected;
        ...
        {
            if (string.IsNullOrWhiteSpace(text) || IsJawsDetectedNow || _announcer.IsMuted) return;
